...
export const QuestionVault: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in max-w-7xl mx-auto pb-32 px-4">
      
      {/* Search & Fixed Filter Bar - Solid background to prevent see-through "moving" effect */}
      <section className="bg-[#020617] p-4 rounded-xl border border-slate-800 sticky top-24 z-40 shadow-2xl ring-1 ring-white/5">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
          <div className="lg:col-span-4 relative group">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-3 bg-slate-900 border border-slate-700 rounded-lg outline-none focus:border-gold-500 shadow-inner transition-all text-sm font-bold text-white placeholder:text-slate-600"
            />
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-4">
           ...
           {filteredQuestions.map((item) => (
             <div 
               ...
               className="group bg-slate-900/50 p-6 rounded-xl border border-slate-800 hover:border-gold-500/40 hover:bg-slate-900 transition-all duration-300 cursor-pointer shadow-sm relative overflow-hidden"
             >
               <div className="flex justify-between items-start mb-4">
                  <span className="px-2 py-0.5 bg-slate-800 text-gold-500 text-[8px] font-black uppercase tracking-widest rounded border border-slate-700">
                    {item.category}
                  </span>
                  <ChevronRight size={16} className="text-slate-600 group-hover:text-gold-500 transition-all group-hover:translate-x-1" />
               </div>
               <h3 className="text-xl font-black text-white uppercase leading-tight mb-3">
                 {item.q}
               </h3>
               <p className="text-slate-400 text-sm leading-relaxed italic line-clamp-1">
                 "{item.a}"
               </p>
               <div className="mt-4 pt-4 border-t border-slate-800 flex items-center justify-between text-[9px] font-black uppercase tracking-widest text-slate-500 group-hover:text-gold-500 transition-colors">
        ...
        <div className="lg:col-span-4">
           <div className="bg-slate-900 p-8 rounded-xl text-white shadow-xl border border-slate-800 space-y-6 sticky top-48">
                  ...
                  {activeView === 'text' ? (
                    ...
                    <div className="h-full flex flex-col justify-center animate-slide-up">
                       <div className="aspect-video w-full rounded-2xl overflow-hidden bg-black shadow-2xl relative border border-slate-800">
                          <iframe 
                            src={`${selectedQuestion.videoUrl}?autoplay=1`} 
